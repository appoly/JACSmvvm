...
public abstract class JACSViewHolder<T> extends RecyclerView.ViewHolder {

    public int position;

    public JACSViewHolder(@NonNull View itemView) {
        super(itemView);
    }
     ...
     */
    public abstract void onBind(T item, @Nullable JACSOnRecyclerViewItemClicked<T> listener);
